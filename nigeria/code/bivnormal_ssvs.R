...
spatHyperparams <- hyper(Z = Zspat,
                         Kinv = ginv(nigeria.gra) ,
                         a =5 ,c = ct, alpha1 = alpha, alpha2 = alpha,R = 1e4, myseed = 1223
                         )
...
# load(paste0("nigeria/hyperp_", alpha, "_c",ct,".RData"))
